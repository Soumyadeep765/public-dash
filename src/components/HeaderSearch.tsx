              ...
              {suggest.bots.map((bot) => {
                ...
                return (
                  <Link
                    ...
                    href={href}
                    className="flex items-start gap-2 px-3 py-2.5 text-sm hover:bg-row-hover"
                    onClick={closeAll}
                    role="option"
                  >
                    <BookMarked size={14} className="mt-0.5 shrink-0 text-muted" />
                    <span className="min-w-0 flex-1">
                      ...
                      {category ? (
                        <span className="mt-0.5 block text-[11px] text-muted">{category}</span>
                      ) : null}
                    </span>
                    <span className="shrink-0 text-xs text-muted">Jump to</span>
                  </Link>
